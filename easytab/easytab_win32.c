...
/*
enum EasyTabButton {
    EasyTabButton_Pen_Touch = 1 << 0, // Pen is touching tablet
    EasyTabButton_Pen_Lower = 1 << 1, // Lower pen button is pressed
    EasyTabButton_Pen_Upper = 1 << 2, // Upper pen button is pressed
};
*/
...
/* TODOs:
   - Null checks and warnings for EasyTab
   - Differentiate between stylus and eraser in the API
   - Linux support for relative mode
   - Documentation for relative mode
*/
